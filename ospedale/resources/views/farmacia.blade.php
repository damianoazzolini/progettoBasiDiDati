    ...
    <div class="row">
        <div class="form-row col-md-8">
            ...
            <div class="col">
                ...
                <a type="button" class="btn btn-primary" href="/farmacia"><i class="fas fa-list-ul" style="color:white"></i> Mostra tutti</a>
            </div>
        </div>
        <div class="col">
                <a type="button" class="btn btn-primary float-sm-right" href="/aggiungiFarmaco"><i class="fas fa-plus" style="color:white"></i> Aggiungi nuovo</a>
        </div>
    </div>
</form>
<br/>
    ...
    <tr>
        ...
        <td>
            <div>
                ...
                <a type="button" class="btn btn-warning" href="/modificaFarmaco/{{ $farmaco->id}}"><i class="fas fa-edit"></i></a>
