...
<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <p>Stai aggiornando i dati del componente dello staff.</p>
      ...
      <div class="card-body">
        ...
        <div class="form-row">
          <div class="form-group row col-md-6">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" id="identificativo" name="identificativo" value="{{ $datiStaff->identificativo }}">
                </div>
          </div>
        </div>
      </div>
    ...
    <div class="card bg-light">
      ...
      <div class="card-body">
        <div class="form-row">
          <div class="form-group row col-md-6">
              <label for="nomeReparto" class="col-sm-2 col-form-label">Nome</label>
              <div class="col-sm-10">
              <input type="text" class="form-control" id="nomeReparto" name="nomeReparto" value="{{ $reparto->nome }}">
              </div>
          </div>
          <div class="form-group row col-md-6">
              <label for="descrizioneReparto" class="col-sm-2 col-form-label">Descrizione</label>
              <div class="col-sm-10">
              <input type="text" class="form-control" id="descrizioneReparto" name="descrizioneReparto" value="{{ $reparto->descrizione }}">
              </div>
          </div>
        </div>
        <div class="form-group row">
            <label for="identificativoReparto" class="col-sm-2 col-form-label">Identificativo
            <textarea cols="40" rows="5" class="form-control" id="identificativoReparto" name="identificativoReparto">{{ $reparto->identificativo }}</textarea>
            </div>
        </div>
      </div>
    </div>
