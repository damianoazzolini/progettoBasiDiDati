...
\subsection{Traduzione entità forti}

\subsection{Traduzione entità deboli}

\subsection{Traduzioni associazioni 1:1}

\subsection{Traduzioni associazioni 1:N}

\subsection{Traduzioni associazioni N:M}

Per ogni associazione \textit{N:M} è stata creata una nuova tabella nel database, in particolare:
\begin{itemize}
