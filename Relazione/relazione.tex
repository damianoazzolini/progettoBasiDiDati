...
Per tradurre una associazione \textit{1:N}, nel lato \textit{N} viene inserita la chiave primaria dell'entità lato \textit{1}. In questo caso sono quindi state inserite le seguenti chiavi:
\begin{itemize}
