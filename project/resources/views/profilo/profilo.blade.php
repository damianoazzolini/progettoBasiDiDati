...
<div class="container profile">
	...
	<div class="row">
		...
		@if($boolean_amici==1)
			...
			<div class="col-sm-6">
                 <div class="classedarimuovere">
				<input type="hidden" id="username" value="{{ $user->nome }}"/>
	                	<input type="hidden" id="surname" value="{{ $user->cognome }}"/>
	                	<input type="hidden" id="image" value="{{ $user->immagine }}"/>
	                	<input type="hidden" id="userID" value="{{ $userID }}"/>
				<?php if ($userID == $utente->utenteID) {?>
				<div class="row">
					<div class="col">
